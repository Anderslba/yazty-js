...
const results = [
  {
    title: "1-s",
    result: -1,
    calcResult: (frequency) => oneToSix(frequency, 1),
  },
  {
    title: "2-s",
    result: -1,
  ...
  { title: "Chance", result: -1, calcResult: (frequency) => chance(frequency) },
  { title: "Yatzy", result: -1, calcResult: (frequency) => yatzy(frequency) },
];
